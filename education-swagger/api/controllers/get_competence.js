...
module.exports.getSphere = function getSphere(req, res, next) {
  var rating = req.query.level || '3.00';
  var product = req.param("corseId");

  var courses = {};
  courses['application/json'] =
  JSON.parse(dummyjson.parse( RecommendedCoursesSchema, {mockdata: {"level": rating}}));
